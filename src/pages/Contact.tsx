  ...
  return (
    ...
    <section className="mt-6 bg-light py-16 px-4" id="contact">
        <div className="max-w-6xl mx-auto bg-white border rounded-2xl shadow-lg bg-gradient-to-r from-greenLight to-secondary">
            <div className="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto text-body">
                <div>
                    <h1 className="text-2xl lg:text-4xl lg:w-1/2 text-heading">Let's Talk</h1>
                    <p className="mt-3 text-body text-base leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
                    <div className="mt-12">
                        <h2 className="font-semibold text-xl text-primary">Email</h2>
                        <ul className="mt-3">
