...
const About = () => {
  return (
    <section className="text-body container max-md:max-w-md mx-auto" id='about'>
      <div className="grid md:grid-cols-2 items-center md:gap-8 gap-6">
        ...
        <div className="lg:h-[550px] md:h-[550px] flex items-center relative max-md:before:hidden before:absolute before:bg-yellowLight before:h-[120%] before:w-[120%] before:right-0 before:z-0 before:shadow-md">
          <img src="/image13.webp" className="rounded-3xl lg:w-4/5 z-50 relative" alt="Dining Experience" />
        </div>
      </div>
