                        ...
                        {content.text.subHeading && (
                            <>
                                <h1 className='flex-1 text-4xl lg:text-5xl font-bold text-heading'>
                                    ...
                                    <span className="bg-gradient-to-r from-indigo-500 via-blue-300 to-indigo-500 text-nowrap text-transparent bg-clip-text font-['Caveat'] px-2">{ content.text.subHeading.text2 }</span> {" "}
                                </h1>
