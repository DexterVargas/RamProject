...
const Cta = () => {
    return (
        <section className={`flex justify-center items-center sm:my-16 my-6 sm:px-16 px-6 sm:py-12 py-4 sm:flex-row flex-col rounded-[20px] box-shadow border shadow-md container mx-auto`}>
            <div className='flex-1 flex flex-col'>
                ...
                <p className={`font-normal text-dimWhite text-[18px] leading-[30.8px] max-w-[600px] mt-5`}>
