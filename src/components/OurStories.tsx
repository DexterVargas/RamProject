...
<div className="container mt-24 mx-auto md:px-6 rounded-lg border border-gray-200">
  ...
  <section className="mb-6">
    ...
    <div className='scroll-mt-[76px] flex w-full flex-col items-center justify-center mb-16' id='howitworks'>      
    ...
    <div className="mb-16 flex flex-wrap px-4">
        <div className="mb-6 hidden sm:flex justify-center items-center lg:mb-0 lg:w-6/12 lg:pr-6 mx-auto">
            <img src="/image2.jpg" className="rounded-3xl object-contain z-10 shadow-md" alt="about us" />
        </div>
    ...
    <div className="mb-16 flex flex-wrap px-4">
        ...
        <div className="mb-6 hidden sm:flex justify-center items-center lg:mb-0 lg:w-6/12 lg:pr-6 mx-auto">
            <img src="/image3.webp" className="rounded-3xl object-contain z-10 shadow-md" alt="about us" />
        </div>
    </div>
  </section>
  ...
  <div className="flex w-full flex-col items-center justify-center border-t-2 border-gray-200 p-8 mb-6">    
        ...
        <div className="mt-8 text-center">      
            ...
            <ul className="mt-6 space-y-4">
                ...
                <li key={i} className="flex items-center justify-start text-base leading-relaxed">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="shrink-0 w-8 h-8 mr-2 text-red-400">
